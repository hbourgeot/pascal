  ...
  >
    <div class="w-full mt-5 flex flex-wrap gap-5 flex-center">
      <a
        ...
        class="flex w-full btn variant-filled justify-center items-center h-fit md:w-[200px] p-4 rounded-xl text-white bg-[#e78ae2]"
        >Configuración</a
      ><a
        href="/coordinadores/registrar_docente"
        class="w-full btn variant-filled h-fit md:w-[200px] p-4 rounded-xl text-white bg-[#e78ae2]"
      ...
      ><a
        ...
        class="flex w-full justify-center items-center btn variant-filled h-fit md:w-[200px] p-4 rounded-xl text-white bg-[#e78ae2]"
        >Ver Materias</a
      ><a
